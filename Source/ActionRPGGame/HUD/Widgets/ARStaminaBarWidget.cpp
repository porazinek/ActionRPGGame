...
void SARStaminaBarWidget::Construct(const FArguments& InArgs)
{
...
int32 SARStaminaBarWidget::OnPaint(const FGeometry& AllottedGeometry, const FSlateRect& MyClippingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled) const
{
	...
	if (MyAttrComp.IsValid())
	{
				...
				float HealthWidth = (MyAttrComp->Stamina * WidgetSize.X) / MyAttrComp->MaxStamina;
